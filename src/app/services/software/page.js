      ...
      <div className="page active" id="page-service-software">
          ...
          <div className="container sp-hero-inner grid-split-hero">
            <div className="fade-up text-left">
              ...
              <h1 className="sp-hero-title">
                Software that <br /><span className="highlight">Powers Enterprises.</span>
              </h1>
              ...
              <div className="hero-actions">
                <Link href="/contact" className="btn-primary">Start a Development Project →</Link>
              </div>
            </div>
        ...
        <section style={{ padding: '100px 0', background: 'var(--white)' }}>
          <div className="container">
            <h2 className="section-title text-center" style={{ marginBottom: '60px' }}>Our Technical <span className="highlight">DNA</span></h2>
          ...
          <div className="container">
            <div className="grid-split-hero">
              <div className="fade-up">
                <img src="/web-dev-workspace.png" alt="OCC Dashboard" style={{ width: '100%', borderRadius: '32px', boxShadow: 'var(--shadow-lg)' }} />
              </div>
              <div className="fade-up text-left">
                <h2 className="section-title" style={{ textAlign: 'left', marginBottom: '30px' }}>Built for <span className="highlight">Mission-Critical</span> Visibility.</h2>
