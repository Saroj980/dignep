                        ...
                        <ul>
                          ...
                          <li>
                            <Link href="/services/soc-noc">
                              ...
                              <div className="mega-text">
                                <span className="mega-title">SOC & NOC Services</span>
                                <span className="mega-desc">24/7/365 active operations & monitoring.</span>
                              </div>
                            </Link>
                          </li>
                        </ul>
            ...
            <div className="mobile-dropdown-section">
               ...
               <div className="mobile-sublinks">
                 ...
                 <Link href="/services/security" onClick={() => setMenuOpen(false)}>Cyber Security</Link>
                  <Link href="/services/soc-noc" onClick={() => setMenuOpen(false)}>SOC & NOC Services</Link>
